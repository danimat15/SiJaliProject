...
class _dropdownState extends State<dropdown> {
  ...
  String selectedOption = 'Option 1'; // Pilihan dropdown default
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            buildFormBasedOnSelection(selectedOption),
          ],
        ),
      ),
    );
  ...
  Widget buildFormBasedOnSelection(String selectedOption) {
    switch (selectedOption) {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        Container(
                            margin:
                                EdgeInsets.only(bottom: mediaQueryWidth * 0.05),
                            child: Text(
                              'BANTUAN',
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(bottom: mediaQueryHeight * 0.02),
                          child: Container(
                            // width: 350,
                          ...
                          child: Row(
                            ...
                            children: [
                              MaterialButton(
                                ...
                                child: Padding(
                                  padding:
                                      EdgeInsets.all(mediaQueryWidth * 0.03),
      ...
      case 'Option 2':
        return TextFormField(
          decoration: InputDecoration(labelText: 'Enter data for Option 2'),
        );
